...
function DeleteFile(FileId) {
    ...
    swal.fire({
        title: 'حذف فایل',
        text: "در مورد حذف فایل مطمئن هستید؟",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: "#d33",
        cancelButtonColor: "#3085d6",
        confirmButtonText: 'بله فایل حذف شود',
...
function searchResult() {
    ...
    const url = `/Admin/Uploads/Index?searchkey=${encodeURIComponent(searchValue)}`;
...
function CopyFilePath(filePath) {
    ...
    let absoluteURL = baseURL + filePath.replace("~/", "");
    ...
    navigator.clipboard.writeText(filePath).then(function () {
        ...
        Swal.fire({
            icon: 'success',
            title: 'موفق',
            html: `مسیر فایل کپی شد<br><span style="direction: ltr;">${filePath}</span>`,
