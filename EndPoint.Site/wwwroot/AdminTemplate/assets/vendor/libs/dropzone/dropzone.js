...
function generateThumbnailFromPDF(pdfFile, thumbnailElement) {
    // Load the PDF file
    pdfjsLib.getDocument(pdfFile)
...
function getFileTypeSync() {

    var xhr = new XMLHttpRequest();
    xhr.open("GET", "/Admin/Products/GetJsonData", false);
    xhr.send();

    if (xhr.status === 200) {
        var data = JSON.parse(xhr.responseText);
        if (Array.isArray(data) && data.length > 0) {
            return data[0].filetype;
        } else {
                            ...
                            return (
                                (function () {
                                    ...
                                    var s = {
                                        ...
                                        retryChunks: !1,
                                        retryChunksLimit: 3,
                                        maxFilesize: (getFileTypeSync() === "images") ? 2 : 3,
                                        paramName: "file",
                                        ...
                                        dictCancelUploadConfirmation: "آیا میخواهیدارسال فایل را لغو کنید؟",
                                        ...
                                        addedfile: function (e) {
                                            ...
                                            if (getFileTypeSync() === "images")
                                            {
                                                if (this.files.length > 6) {
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'امکان اضافه کردن فایل جدید وجود ندارد',
                                                        text: 'حداکثر اجازه دارید 6 فایل اضافه کنید'
                                                    });
                                                ...
                                                if (filesize > 2) {
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: `حجم این فایل ${filesize} مگابایت است`,
                                                        text: 'لطفاً فایل با حجم کمتر از 2 مگابایت انتخاب کنید.'
                                                    });
                                                    this.removeFile(file);
                                                    return;
                                                }
                                            }
                                            if (getFileTypeSync() === "documents")
                                            {
                                                if (this.files.length > 6) {
                                                    Swal.fire({
                                                        icon: 'error',
                                                ...
                                                if (filesize > 3) {
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: `حجم این فایل ${filesize} مگابایت است`,
                                                        text: 'لطفاً فایل با حجم کمتر از 3 مگابایت انتخاب کنید.'
                                                    });
                                                    this.removeFile(file);
                                                    return;
                                                }
                                                                    ...
                                                                    return e.listeners.push({
                                                                        ...
                                                                        events: {
                                                                            click: function (n) {
                                                                                ...
                                                                                // Set accepted files for the hidden file input
                                                                                e.hiddenFileInput.accept = acceptedFiles;
